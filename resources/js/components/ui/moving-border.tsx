...
export function MovingBorder({
    ...
    return (
        <>
            ...
            >
                <div className="h-2 w-2 rounded-full bg-gradient-to-r from-primary via-secondary to-accent blur-[1px]" />
            </motion.div>
            <motion.div
                style={{
                    position: "absolute",
            ...
            >
                <div className="h-4 w-4 rounded-full bg-gradient-to-r from-primary via-secondary to-accent blur-[2px]" />
            </motion.div>
        </>
    );
}
